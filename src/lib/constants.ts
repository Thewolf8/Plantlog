...
export const TAG_COLOR_OPTIONS = [
  { bg: 'bg-red-500/20',     text: 'text-red-300',     border: 'border-red-500/30',     name: 'red',     hex: '#ef4444' },
  { bg: 'bg-orange-500/20',  text: 'text-orange-300',  border: 'border-orange-500/30',  name: 'orange',  hex: '#f97316' },
  { bg: 'bg-amber-500/20',   text: 'text-amber-300',   border: 'border-amber-500/30',   name: 'amber',   hex: '#f59e0b' },
  { bg: 'bg-yellow-500/20',  text: 'text-yellow-300',  border: 'border-yellow-500/30',  name: 'yellow',  hex: '#eab308' },
  { bg: 'bg-lime-500/20',    text: 'text-lime-300',    border: 'border-lime-500/30',    name: 'lime',    hex: '#84cc16' },
  { bg: 'bg-green-500/20',   text: 'text-green-300',   border: 'border-green-500/30',   name: 'green',   hex: '#22c55e' },
  { bg: 'bg-emerald-500/20', text: 'text-emerald-300', border: 'border-emerald-500/30', name: 'emerald', hex: '#10b981' },
  { bg: 'bg-teal-500/20',    text: 'text-teal-300',    border: 'border-teal-500/30',    name: 'teal',    hex: '#14b8a6' },
  { bg: 'bg-cyan-500/20',    text: 'text-cyan-300',    border: 'border-cyan-500/30',    name: 'cyan',    hex: '#06b6d4' },
  { bg: 'bg-sky-500/20',     text: 'text-sky-300',     border: 'border-sky-500/30',     name: 'sky',     hex: '#0ea5e9' },
  { bg: 'bg-blue-500/20',    text: 'text-blue-300',    border: 'border-blue-500/30',    name: 'blue',    hex: '#3b82f6' },
  { bg: 'bg-indigo-500/20',  text: 'text-indigo-300',  border: 'border-indigo-500/30',  name: 'indigo',  hex: '#6366f1' },
  { bg: 'bg-violet-500/20',  text: 'text-violet-300',  border: 'border-violet-500/30',  name: 'violet',  hex: '#8b5cf6' },
  { bg: 'bg-purple-500/20',  text: 'text-purple-300',  border: 'border-purple-500/30',  name: 'purple',  hex: '#a855f7' },
  { bg: 'bg-fuchsia-500/20', text: 'text-fuchsia-300', border: 'border-fuchsia-500/30', name: 'fuchsia', hex: '#d946ef' },
  { bg: 'bg-pink-500/20',    text: 'text-pink-300',    border: 'border-pink-500/30',    name: 'pink',    hex: '#ec4899' },
  { bg: 'bg-rose-500/20',    text: 'text-rose-300',    border: 'border-rose-500/30',    name: 'rose',    hex: '#f43f5e' },
  { bg: 'bg-slate-500/20',   text: 'text-slate-300',   border: 'border-slate-500/30',   name: 'slate',   hex: '#64748b' },
];
